...
ggplot(dat, aes(x = n, y = n_max, color = m, label = formatC(n_max, digits = 4))) +
  ...
  coord_cartesian(ylim = c(1, 5e7), xlim = c(0.5, 5.5)) +
...
Stworzono 524 284 zredukowane alfabety o różnych długościach (od trzech do sześciu grup) wykorzystując metodę grupowań Warda na wybranych cechach fizykochemicznych z basy właściwości aminokwasów AAIndex [@kawashima_aaindex:_2008].
...
Mój program, signalHsmm, jest w stanie wykrywać
